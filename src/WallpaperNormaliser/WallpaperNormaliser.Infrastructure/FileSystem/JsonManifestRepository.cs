...
public sealed class JsonManifestRepository : IManifestRepository
{
    ...
    public Task<IReadOnlyList<ManifestDocument>> GetManyAsync(ManifestQuery query, CancellationToken cancellationToken = default) => throw new NotImplementedException();

    public Task SaveAsync(ManifestDocument document, CancellationToken cancellationToken = default) => throw new NotImplementedException();
